    ...
    <div className="h-auto bg-white w-full">
      <div>
        <img
          src={logo2}
          alt="logo"
          className="absolute mt-10 ml-10 top-[9px] left-[0px] object-cover object right h-[100px] w-[200px] inline"
        />
      </div>
      ...
      <div className="create bg-gray-300 w-full ">
        <div className="flex flex-col space-y-4 justify-center">
          <div>
            <a href="https://www.google.com/maps/place/Chandragiri,+Odisha+761017/@19.3014831,84.2765521,15z/data=!3m1!4b1!4m5!3m4!1s0x3a3d2811fcb782db:0x589a32b67f33c5ff!8m2!3d19.3002058!4d84.283838">
              <img
                src={maps}
                className="relative top-[400px] left-[700px]"
                alt=""
              />
            </a>
          </div>
        ...
        <h2 className="text-4xl font-bold text-orange-800 ml-[200px] text-left ">
          Add a new blog
        </h2>
        <div className="buttons flex flex-row space-x-1 ml-[200px] mt-[40px]">
          <div>
            <button className="bg-white w-[120px] rounded-md h-auto p-4">
              New
            </button>
          </div>
          <div>
          ...
          <div>
            <button className="bg-orange-400 w-[120px] rounded-md h-auto p-4">
              Publish
            </button>
          </div>
        </div>
        <div className="bg-white w-[800px] mt-10 ml-[200px] mr-[600px] h-[600px] p-10  flex flex-col space-y-24">
          <form onSubmit={handleSubmit}>
            <div>
              ...
              <input
                className="text-center mr-[400px]"
                type="text"
                required
                value={title}
            ...
            <div className="">
              ...
              <input
                className=" text-center mr-[385px] mt-[50px]"
                type="text"
                required
                value={author}
