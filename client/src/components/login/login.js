...
const Login=()=>{
    ...
    return(
        ...
        <div>
            ...
            <button onClick={login} className="absolute top-[70%] left-[29.5%] rounded-full bg-orange-400 h-[50px] w-[150px] font-bold text-lg text-white hover:text-orange-600 hover:bg-white hover:outline outline-1">Log in</button>
            <div className="absolute top-[80%] left-[27%]">Don't have an account?<span className=" underline underline-offset-2 text-orange-800 cursor-pointer" onClick={()=>navigate("/signup")}> Sign Up</span></div>
